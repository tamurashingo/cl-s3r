;;; Font Awesome Free - message icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-message
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-message))

(in-package #:cl-s3r.components.fa-message)

(define-component fa-message (&key color size width height)
