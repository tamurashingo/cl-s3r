;;; Font Awesome Free - soccer-ball icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-soccer-ball
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-soccer-ball))

(in-package #:cl-s3r.components.fa-soccer-ball)

(define-component fa-soccer-ball (&key color size width height)
