;;; Font Awesome Free - hand-back-fist icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-back-fist
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-back-fist))

(in-package #:cl-s3r.components.fa-hand-back-fist)

(define-component fa-hand-back-fist (&key color size width height)
