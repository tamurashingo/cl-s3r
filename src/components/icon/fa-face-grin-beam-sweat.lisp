;;; Font Awesome Free - face-grin-beam-sweat icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-grin-beam-sweat
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-grin-beam-sweat))

(in-package #:cl-s3r.components.fa-face-grin-beam-sweat)

(define-component fa-face-grin-beam-sweat (&key color size width height)
