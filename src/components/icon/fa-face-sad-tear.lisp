;;; Font Awesome Free - face-sad-tear icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-sad-tear
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-sad-tear))

(in-package #:cl-s3r.components.fa-face-sad-tear)

(define-component fa-face-sad-tear (&key color size width height)
