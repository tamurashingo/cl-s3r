;;; Font Awesome Free - user-circle icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-user-circle
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-user-circle))

(in-package #:cl-s3r.components.fa-user-circle)

(define-component fa-user-circle (&key color size width height)
