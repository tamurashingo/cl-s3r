;;; Font Awesome Free - face-kiss icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-kiss
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-kiss))

(in-package #:cl-s3r.components.fa-face-kiss)

(define-component fa-face-kiss (&key color size width height)
