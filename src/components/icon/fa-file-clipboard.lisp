;;; Font Awesome Free - file-clipboard icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-clipboard
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-clipboard))

(in-package #:cl-s3r.components.fa-file-clipboard)

(define-component fa-file-clipboard (&key color size width height)
