;;; Font Awesome Free - grin-tongue-squint icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-grin-tongue-squint
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-grin-tongue-squint))

(in-package #:cl-s3r.components.fa-grin-tongue-squint)

(define-component fa-grin-tongue-squint (&key color size width height)
