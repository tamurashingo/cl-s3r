;;; Font Awesome Free - arrow-alt-circle-right icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-arrow-alt-circle-right
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-arrow-alt-circle-right))

(in-package #:cl-s3r.components.fa-arrow-alt-circle-right)

(define-component fa-arrow-alt-circle-right (&key color size width height)
