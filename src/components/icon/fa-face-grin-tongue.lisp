;;; Font Awesome Free - face-grin-tongue icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-grin-tongue
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-grin-tongue))

(in-package #:cl-s3r.components.fa-face-grin-tongue)

(define-component fa-face-grin-tongue (&key color size width height)
