;;; Font Awesome Free - images icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-images
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-images))

(in-package #:cl-s3r.components.fa-images)

(define-component fa-images (&key color size width height)
