;;; Font Awesome Free - file-code icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-code
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-code))

(in-package #:cl-s3r.components.fa-file-code)

(define-component fa-file-code (&key color size width height)
