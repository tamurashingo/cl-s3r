;;; Font Awesome Free - copy icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-copy
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-copy))

(in-package #:cl-s3r.components.fa-copy)

(define-component fa-copy (&key color size width height)
