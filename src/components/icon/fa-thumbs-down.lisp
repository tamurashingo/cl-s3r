;;; Font Awesome Free - thumbs-down icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-thumbs-down
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-thumbs-down))

(in-package #:cl-s3r.components.fa-thumbs-down)

(define-component fa-thumbs-down (&key color size width height)
