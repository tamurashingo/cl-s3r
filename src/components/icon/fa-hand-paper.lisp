;;; Font Awesome Free - hand-paper icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-paper
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-paper))

(in-package #:cl-s3r.components.fa-hand-paper)

(define-component fa-hand-paper (&key color size width height)
