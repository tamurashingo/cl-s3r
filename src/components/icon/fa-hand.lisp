;;; Font Awesome Free - hand icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand))

(in-package #:cl-s3r.components.fa-hand)

(define-component fa-hand (&key color size width height)
