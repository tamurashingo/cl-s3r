;;; Font Awesome Free - hand-point-down icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-point-down
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-point-down))

(in-package #:cl-s3r.components.fa-hand-point-down)

(define-component fa-hand-point-down (&key color size width height)
