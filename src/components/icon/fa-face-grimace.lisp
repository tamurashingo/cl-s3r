;;; Font Awesome Free - face-grimace icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-grimace
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-grimace))

(in-package #:cl-s3r.components.fa-face-grimace)

(define-component fa-face-grimace (&key color size width height)
