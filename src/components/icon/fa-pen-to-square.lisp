;;; Font Awesome Free - pen-to-square icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-pen-to-square
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-pen-to-square))

(in-package #:cl-s3r.components.fa-pen-to-square)

(define-component fa-pen-to-square (&key color size width height)
