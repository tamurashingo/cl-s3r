;;; Font Awesome Free - frown icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-frown
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-frown))

(in-package #:cl-s3r.components.fa-frown)

(define-component fa-frown (&key color size width height)
