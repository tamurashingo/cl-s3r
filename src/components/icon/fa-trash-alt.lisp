;;; Font Awesome Free - trash-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-trash-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-trash-alt))

(in-package #:cl-s3r.components.fa-trash-alt)

(define-component fa-trash-alt (&key color size width height)
