;;; Font Awesome Free - note-sticky icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-note-sticky
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-note-sticky))

(in-package #:cl-s3r.components.fa-note-sticky)

(define-component fa-note-sticky (&key color size width height)
