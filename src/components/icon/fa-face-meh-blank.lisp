;;; Font Awesome Free - face-meh-blank icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-meh-blank
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-meh-blank))

(in-package #:cl-s3r.components.fa-face-meh-blank)

(define-component fa-face-meh-blank (&key color size width height)
