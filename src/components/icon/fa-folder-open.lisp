;;; Font Awesome Free - folder-open icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-folder-open
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-folder-open))

(in-package #:cl-s3r.components.fa-folder-open)

(define-component fa-folder-open (&key color size width height)
