;;; Font Awesome Free - face-kiss-beam icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-kiss-beam
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-kiss-beam))

(in-package #:cl-s3r.components.fa-face-kiss-beam)

(define-component fa-face-kiss-beam (&key color size width height)
