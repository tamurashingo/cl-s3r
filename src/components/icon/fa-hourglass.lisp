;;; Font Awesome Free - hourglass icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hourglass
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hourglass))

(in-package #:cl-s3r.components.fa-hourglass)

(define-component fa-hourglass (&key color size width height)
