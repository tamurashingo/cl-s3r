;;; Font Awesome Free - check-circle icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-check-circle
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-check-circle))

(in-package #:cl-s3r.components.fa-check-circle)

(define-component fa-check-circle (&key color size width height)
