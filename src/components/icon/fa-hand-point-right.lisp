;;; Font Awesome Free - hand-point-right icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-point-right
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-point-right))

(in-package #:cl-s3r.components.fa-hand-point-right)

(define-component fa-hand-point-right (&key color size width height)
