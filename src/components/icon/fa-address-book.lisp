;;; Font Awesome Free - address-book icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-address-book
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-address-book))

(in-package #:cl-s3r.components.fa-address-book)

(define-component fa-address-book (&key color size width height)
