;;; Font Awesome Free - face-laugh-squint icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-laugh-squint
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-laugh-squint))

(in-package #:cl-s3r.components.fa-face-laugh-squint)

(define-component fa-face-laugh-squint (&key color size width height)
