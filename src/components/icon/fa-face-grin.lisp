;;; Font Awesome Free - face-grin icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-grin
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-grin))

(in-package #:cl-s3r.components.fa-face-grin)

(define-component fa-face-grin (&key color size width height)
