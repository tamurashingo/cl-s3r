;;; Font Awesome Free - arrow-alt-circle-up icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-arrow-alt-circle-up
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-arrow-alt-circle-up))

(in-package #:cl-s3r.components.fa-arrow-alt-circle-up)

(define-component fa-arrow-alt-circle-up (&key color size width height)
