;;; Font Awesome Free - hand-point-left icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-point-left
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-point-left))

(in-package #:cl-s3r.components.fa-hand-point-left)

(define-component fa-hand-point-left (&key color size width height)
