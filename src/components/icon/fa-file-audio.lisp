;;; Font Awesome Free - file-audio icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-audio
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-audio))

(in-package #:cl-s3r.components.fa-file-audio)

(define-component fa-file-audio (&key color size width height)
