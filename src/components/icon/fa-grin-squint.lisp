;;; Font Awesome Free - grin-squint icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-grin-squint
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-grin-squint))

(in-package #:cl-s3r.components.fa-grin-squint)

(define-component fa-grin-squint (&key color size width height)
