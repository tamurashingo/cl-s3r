;;; Font Awesome Free - hand-pointer icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-pointer
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-pointer))

(in-package #:cl-s3r.components.fa-hand-pointer)

(define-component fa-hand-pointer (&key color size width height)
