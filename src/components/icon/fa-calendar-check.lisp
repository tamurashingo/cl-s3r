...
(defpackage #:cl-s3r.components.fa-calendar-check
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-calendar-check))

(in-package #:cl-s3r.components.fa-calendar-check)

(define-component fa-calendar-check (&key color size width height)
