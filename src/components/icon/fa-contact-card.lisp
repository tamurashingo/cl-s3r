;;; Font Awesome Free - contact-card icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-contact-card
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-contact-card))

(in-package #:cl-s3r.components.fa-contact-card)

(define-component fa-contact-card (&key color size width height)
