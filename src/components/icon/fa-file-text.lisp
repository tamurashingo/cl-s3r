;;; Font Awesome Free - file-text icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-text
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-text))

(in-package #:cl-s3r.components.fa-file-text)

(define-component fa-file-text (&key color size width height)
