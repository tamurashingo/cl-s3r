;;; Font Awesome Free - calendar icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-calendar
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-calendar))

(in-package #:cl-s3r.components.fa-calendar)

(define-component fa-calendar (&key color size width height)
