;;; Font Awesome Free - face-laugh-beam icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-laugh-beam
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-laugh-beam))

(in-package #:cl-s3r.components.fa-face-laugh-beam)

(define-component fa-face-laugh-beam (&key color size width height)
