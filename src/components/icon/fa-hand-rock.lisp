;;; Font Awesome Free - hand-rock icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-rock
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-rock))

(in-package #:cl-s3r.components.fa-hand-rock)

(define-component fa-hand-rock (&key color size width height)
