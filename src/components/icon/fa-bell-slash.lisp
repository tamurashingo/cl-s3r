;;; Font Awesome Free - bell-slash icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-bell-slash
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-bell-slash))

(in-package #:cl-s3r.components.fa-bell-slash)

(define-component fa-bell-slash (&key color size width height)
