;;; Font Awesome Free - house icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-house
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-house))

(in-package #:cl-s3r.components.fa-house)

(define-component fa-house (&key color size width height)
