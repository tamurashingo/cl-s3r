;;; Font Awesome Free - rectangle-list icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-rectangle-list
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-rectangle-list))

(in-package #:cl-s3r.components.fa-rectangle-list)

(define-component fa-rectangle-list (&key color size width height)
