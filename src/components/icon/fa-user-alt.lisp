;;; Font Awesome Free - user-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-user-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-user-alt))

(in-package #:cl-s3r.components.fa-user-alt)

(define-component fa-user-alt (&key color size width height)
