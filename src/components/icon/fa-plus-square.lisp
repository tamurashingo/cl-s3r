;;; Font Awesome Free - plus-square icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-plus-square
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-plus-square))

(in-package #:cl-s3r.components.fa-plus-square)

(define-component fa-plus-square (&key color size width height)
