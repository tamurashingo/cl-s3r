;;; Font Awesome Free - play-circle icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-play-circle
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-play-circle))

(in-package #:cl-s3r.components.fa-play-circle)

(define-component fa-play-circle (&key color size width height)
