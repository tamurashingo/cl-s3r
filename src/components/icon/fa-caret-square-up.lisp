;;; Font Awesome Free - caret-square-up icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-caret-square-up
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-caret-square-up))

(in-package #:cl-s3r.components.fa-caret-square-up)

(define-component fa-caret-square-up (&key color size width height)
