;;; Font Awesome Free - font-awesome-logo-full icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-font-awesome-logo-full
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-font-awesome-logo-full))

(in-package #:cl-s3r.components.fa-font-awesome-logo-full)

(define-component fa-font-awesome-logo-full (&key color size width height)
