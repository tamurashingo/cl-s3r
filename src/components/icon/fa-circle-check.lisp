;;; Font Awesome Free - circle-check icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-circle-check
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-circle-check))

(in-package #:cl-s3r.components.fa-circle-check)

(define-component fa-circle-check (&key color size width height)
