;;; Font Awesome Free - closed-captioning icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-closed-captioning
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-closed-captioning))

(in-package #:cl-s3r.components.fa-closed-captioning)

(define-component fa-closed-captioning (&key color size width height)
