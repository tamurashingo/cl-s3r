;;; Font Awesome Free - kiss-wink-heart icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-kiss-wink-heart
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-kiss-wink-heart))

(in-package #:cl-s3r.components.fa-kiss-wink-heart)

(define-component fa-kiss-wink-heart (&key color size width height)
