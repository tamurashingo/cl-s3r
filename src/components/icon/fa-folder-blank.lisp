;;; Font Awesome Free - folder-blank icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-folder-blank
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-folder-blank))

(in-package #:cl-s3r.components.fa-folder-blank)

(define-component fa-folder-blank (&key color size width height)
