;;; Font Awesome Free - edit icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-edit
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-edit))

(in-package #:cl-s3r.components.fa-edit)

(define-component fa-edit (&key color size width height)
