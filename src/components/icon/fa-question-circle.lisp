;;; Font Awesome Free - question-circle icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-question-circle
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-question-circle))

(in-package #:cl-s3r.components.fa-question-circle)

(define-component fa-question-circle (&key color size width height)
