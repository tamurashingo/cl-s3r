;;; Font Awesome Free - commenting icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-commenting
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-commenting))

(in-package #:cl-s3r.components.fa-commenting)

(define-component fa-commenting (&key color size width height)
