;;; Font Awesome Free - futbol icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-futbol
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-futbol))

(in-package #:cl-s3r.components.fa-futbol)

(define-component fa-futbol (&key color size width height)
