;;; Font Awesome Free - face-grin-squint-tears icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-grin-squint-tears
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-grin-squint-tears))

(in-package #:cl-s3r.components.fa-face-grin-squint-tears)

(define-component fa-face-grin-squint-tears (&key color size width height)
