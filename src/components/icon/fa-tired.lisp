;;; Font Awesome Free - tired icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-tired
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-tired))

(in-package #:cl-s3r.components.fa-tired)

(define-component fa-tired (&key color size width height)
