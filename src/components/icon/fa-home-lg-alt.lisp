;;; Font Awesome Free - home-lg-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-home-lg-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-home-lg-alt))

(in-package #:cl-s3r.components.fa-home-lg-alt)

(define-component fa-home-lg-alt (&key color size width height)
