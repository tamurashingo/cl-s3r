;;; Font Awesome Free - caret-square-left icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-caret-square-left
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-caret-square-left))

(in-package #:cl-s3r.components.fa-caret-square-left)

(define-component fa-caret-square-left (&key color size width height)
