;;; Font Awesome Free - face-laugh icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-laugh
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-laugh))

(in-package #:cl-s3r.components.fa-face-laugh)

(define-component fa-face-laugh (&key color size width height)
