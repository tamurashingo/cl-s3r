;;; Font Awesome Free - handshake-simple icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-handshake-simple
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-handshake-simple))

(in-package #:cl-s3r.components.fa-handshake-simple)

(define-component fa-handshake-simple (&key color size width height)
