;;; Font Awesome Free - calendar-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-calendar-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-calendar-alt))

(in-package #:cl-s3r.components.fa-calendar-alt)

(define-component fa-calendar-alt (&key color size width height)
