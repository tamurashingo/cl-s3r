;;; Font Awesome Free - clock icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-clock
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-clock))

(in-package #:cl-s3r.components.fa-clock)

(define-component fa-clock (&key color size width height)
