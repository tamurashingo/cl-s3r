;;; Font Awesome Free - hospital-wide icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hospital-wide
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hospital-wide))

(in-package #:cl-s3r.components.fa-hospital-wide)

(define-component fa-hospital-wide (&key color size width height)
