;;; Font Awesome Free - circle-down icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-circle-down
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-circle-down))

(in-package #:cl-s3r.components.fa-circle-down)

(define-component fa-circle-down (&key color size width height)
