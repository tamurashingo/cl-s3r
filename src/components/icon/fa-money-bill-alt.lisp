;;; Font Awesome Free - money-bill-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-money-bill-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-money-bill-alt))

(in-package #:cl-s3r.components.fa-money-bill-alt)

(define-component fa-money-bill-alt (&key color size width height)
