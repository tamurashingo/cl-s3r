;;; Font Awesome Free - calendar-xmark icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-calendar-xmark
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-calendar-xmark))

(in-package #:cl-s3r.components.fa-calendar-xmark)

(define-component fa-calendar-xmark (&key color size width height)
