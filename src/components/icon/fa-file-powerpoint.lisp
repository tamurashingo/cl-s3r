;;; Font Awesome Free - file-powerpoint icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-powerpoint
  (:use #:cl)
...
(in-package #:cl-s3r.components.fa-file-powerpoint)

(define-component fa-file-powerpoint (&key color size width height)
