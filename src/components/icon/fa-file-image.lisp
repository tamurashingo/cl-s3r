;;; Font Awesome Free - file-image icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-image
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-image))

(in-package #:cl-s3r.components.fa-file-image)

(define-component fa-file-image (&key color size width height)
