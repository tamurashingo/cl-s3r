;;; Font Awesome Free - snowflake icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-snowflake
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-snowflake))

(in-package #:cl-s3r.components.fa-snowflake)

(define-component fa-snowflake (&key color size width height)
