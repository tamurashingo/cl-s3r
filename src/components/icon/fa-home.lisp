;;; Font Awesome Free - home icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-home
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-home))

(in-package #:cl-s3r.components.fa-home)

(define-component fa-home (&key color size width height)
