;;; Font Awesome Free - handshake-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-handshake-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-handshake-alt))

(in-package #:cl-s3r.components.fa-handshake-alt)

(define-component fa-handshake-alt (&key color size width height)
