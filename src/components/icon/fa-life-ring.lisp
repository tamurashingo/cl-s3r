;;; Font Awesome Free - life-ring icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-life-ring
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-life-ring))

(in-package #:cl-s3r.components.fa-life-ring)

(define-component fa-life-ring (&key color size width height)
