;;; Font Awesome Free - futbol-ball icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-futbol-ball
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-futbol-ball))

(in-package #:cl-s3r.components.fa-futbol-ball)

(define-component fa-futbol-ball (&key color size width height)
