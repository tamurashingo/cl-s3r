;;; Font Awesome Free - list-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-list-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-list-alt))

(in-package #:cl-s3r.components.fa-list-alt)

(define-component fa-list-alt (&key color size width height)
