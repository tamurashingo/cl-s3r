;;; Font Awesome Free - file-lines icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-lines
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-lines))

(in-package #:cl-s3r.components.fa-file-lines)

(define-component fa-file-lines (&key color size width height)
