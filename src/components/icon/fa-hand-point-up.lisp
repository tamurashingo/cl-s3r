;;; Font Awesome Free - hand-point-up icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-point-up
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-point-up))

(in-package #:cl-s3r.components.fa-hand-point-up)

(define-component fa-hand-point-up (&key color size width height)
