;;; Font Awesome Free - share-from-square icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-share-from-square
  (:use #:cl)
...
(in-package #:cl-s3r.components.fa-share-from-square)

(define-component fa-share-from-square (&key color size width height)
