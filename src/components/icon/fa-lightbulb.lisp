;;; Font Awesome Free - lightbulb icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-lightbulb
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-lightbulb))

(in-package #:cl-s3r.components.fa-lightbulb)

(define-component fa-lightbulb (&key color size width height)
