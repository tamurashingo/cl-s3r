;;; Font Awesome Free - clock-four icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-clock-four
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-clock-four))

(in-package #:cl-s3r.components.fa-clock-four)

(define-component fa-clock-four (&key color size width height)
