;;; Font Awesome Free - hand-peace icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-peace
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-peace))

(in-package #:cl-s3r.components.fa-hand-peace)

(define-component fa-hand-peace (&key color size width height)
