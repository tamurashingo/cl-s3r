;;; Font Awesome Free - hand-spock icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-spock
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-spock))

(in-package #:cl-s3r.components.fa-hand-spock)

(define-component fa-hand-spock (&key color size width height)
