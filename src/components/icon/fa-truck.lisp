;;; Font Awesome Free - truck icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-truck
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-truck))

(in-package #:cl-s3r.components.fa-truck)

(define-component fa-truck (&key color size width height)
