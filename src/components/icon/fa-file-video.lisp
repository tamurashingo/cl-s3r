;;; Font Awesome Free - file-video icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-video
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-video))

(in-package #:cl-s3r.components.fa-file-video)

(define-component fa-file-video (&key color size width height)
