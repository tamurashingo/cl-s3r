;;; Font Awesome Free - square-caret-right icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-square-caret-right
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-square-caret-right))

(in-package #:cl-s3r.components.fa-square-caret-right)

(define-component fa-square-caret-right (&key color size width height)
