;;; Font Awesome Free - face-sad-cry icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-sad-cry
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-sad-cry))

(in-package #:cl-s3r.components.fa-face-sad-cry)

(define-component fa-face-sad-cry (&key color size width height)
