;;; Font Awesome Free - grin-squint-tears icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-grin-squint-tears
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-grin-squint-tears))

(in-package #:cl-s3r.components.fa-grin-squint-tears)

(define-component fa-grin-squint-tears (&key color size width height)
