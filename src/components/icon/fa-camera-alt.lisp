;;; Font Awesome Free - camera-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-camera-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-camera-alt))

(in-package #:cl-s3r.components.fa-camera-alt)

(define-component fa-camera-alt (&key color size width height)
