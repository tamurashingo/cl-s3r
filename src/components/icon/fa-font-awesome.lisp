;;; Font Awesome Free - font-awesome icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-font-awesome
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-font-awesome))

(in-package #:cl-s3r.components.fa-font-awesome)

(define-component fa-font-awesome (&key color size width height)
