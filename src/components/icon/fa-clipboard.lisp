;;; Font Awesome Free - clipboard icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-clipboard
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-clipboard))

(in-package #:cl-s3r.components.fa-clipboard)

(define-component fa-clipboard (&key color size width height)
