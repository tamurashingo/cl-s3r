;;; Font Awesome Free - id-card icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-id-card
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-id-card))

(in-package #:cl-s3r.components.fa-id-card)

(define-component fa-id-card (&key color size width height)
