;;; Font Awesome Free - angry icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-angry
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-angry))

(in-package #:cl-s3r.components.fa-angry)

(define-component fa-angry (&key color size width height)
