;;; Font Awesome Free - chess-queen icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-chess-queen
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-chess-queen))

(in-package #:cl-s3r.components.fa-chess-queen)

(define-component fa-chess-queen (&key color size width height)
