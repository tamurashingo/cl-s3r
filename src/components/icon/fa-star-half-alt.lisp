;;; Font Awesome Free - star-half-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-star-half-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-star-half-alt))

(in-package #:cl-s3r.components.fa-star-half-alt)

(define-component fa-star-half-alt (&key color size width height)
