;;; Font Awesome Free - square-check icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-square-check
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-square-check))

(in-package #:cl-s3r.components.fa-square-check)

(define-component fa-square-check (&key color size width height)
