;;; Font Awesome Free - grin-tears icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-grin-tears
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-grin-tears))

(in-package #:cl-s3r.components.fa-grin-tears)

(define-component fa-grin-tears (&key color size width height)
