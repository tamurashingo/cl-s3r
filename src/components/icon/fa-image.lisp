;;; Font Awesome Free - image icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-image
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-image))

(in-package #:cl-s3r.components.fa-image)

(define-component fa-image (&key color size width height)
