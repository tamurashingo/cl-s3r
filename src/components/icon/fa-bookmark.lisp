;;; Font Awesome Free - bookmark icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-bookmark
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-bookmark))

(in-package #:cl-s3r.components.fa-bookmark)

(define-component fa-bookmark (&key color size width height)
