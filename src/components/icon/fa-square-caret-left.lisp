;;; Font Awesome Free - square-caret-left icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-square-caret-left
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-square-caret-left))

(in-package #:cl-s3r.components.fa-square-caret-left)

(define-component fa-square-caret-left (&key color size width height)
