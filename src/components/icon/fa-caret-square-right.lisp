;;; Font Awesome Free - caret-square-right icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-caret-square-right
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-caret-square-right))

(in-package #:cl-s3r.components.fa-caret-square-right)

(define-component fa-caret-square-right (&key color size width height)
