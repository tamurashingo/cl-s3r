;;; Font Awesome Free - chess-bishop icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-chess-bishop
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-chess-bishop))

(in-package #:cl-s3r.components.fa-chess-bishop)

(define-component fa-chess-bishop (&key color size width height)
