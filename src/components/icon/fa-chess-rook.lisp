;;; Font Awesome Free - chess-rook icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-chess-rook
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-chess-rook))

(in-package #:cl-s3r.components.fa-chess-rook)

(define-component fa-chess-rook (&key color size width height)
