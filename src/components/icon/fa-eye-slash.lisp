;;; Font Awesome Free - eye-slash icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-eye-slash
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-eye-slash))

(in-package #:cl-s3r.components.fa-eye-slash)

(define-component fa-eye-slash (&key color size width height)
