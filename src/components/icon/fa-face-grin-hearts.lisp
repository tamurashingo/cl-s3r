;;; Font Awesome Free - face-grin-hearts icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-grin-hearts
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-grin-hearts))

(in-package #:cl-s3r.components.fa-face-grin-hearts)

(define-component fa-face-grin-hearts (&key color size width height)
