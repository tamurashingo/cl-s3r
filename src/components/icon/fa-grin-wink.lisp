;;; Font Awesome Free - grin-wink icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-grin-wink
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-grin-wink))

(in-package #:cl-s3r.components.fa-grin-wink)

(define-component fa-grin-wink (&key color size width height)
