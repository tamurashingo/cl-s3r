;;; Font Awesome Free - credit-card icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-credit-card
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-credit-card))

(in-package #:cl-s3r.components.fa-credit-card)

(define-component fa-credit-card (&key color size width height)
