;;; Font Awesome Free - file-excel icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-excel
  (:use #:cl)
...
(in-package #:cl-s3r.components.fa-file-excel)

(define-component fa-file-excel (&key color size width height)
