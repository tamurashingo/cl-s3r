;;; Font Awesome Free - file-alt icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-alt
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-alt))

(in-package #:cl-s3r.components.fa-file-alt)

(define-component fa-file-alt (&key color size width height)
