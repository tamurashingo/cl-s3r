;;; Font Awesome Free - moon icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-moon
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-moon))

(in-package #:cl-s3r.components.fa-moon)

(define-component fa-moon (&key color size width height)
