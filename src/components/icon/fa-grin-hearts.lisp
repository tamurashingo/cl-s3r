;;; Font Awesome Free - grin-hearts icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-grin-hearts
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-grin-hearts))

(in-package #:cl-s3r.components.fa-grin-hearts)

(define-component fa-grin-hearts (&key color size width height)
