;;; Font Awesome Free - thumbs-up icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-thumbs-up
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-thumbs-up))

(in-package #:cl-s3r.components.fa-thumbs-up)

(define-component fa-thumbs-up (&key color size width height)
