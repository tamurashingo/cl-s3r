;;; Font Awesome Free - folder icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-folder
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-folder))

(in-package #:cl-s3r.components.fa-folder)

(define-component fa-folder (&key color size width height)
