;;; Font Awesome Free - file-zipper icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-zipper
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-zipper))

(in-package #:cl-s3r.components.fa-file-zipper)

(define-component fa-file-zipper (&key color size width height)
