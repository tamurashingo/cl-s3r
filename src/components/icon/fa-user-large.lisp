;;; Font Awesome Free - user-large icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-user-large
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-user-large))

(in-package #:cl-s3r.components.fa-user-large)

(define-component fa-user-large (&key color size width height)
