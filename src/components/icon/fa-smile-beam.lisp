;;; Font Awesome Free - smile-beam icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-smile-beam
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-smile-beam))

(in-package #:cl-s3r.components.fa-smile-beam)

(define-component fa-smile-beam (&key color size width height)
