;;; Font Awesome Free - money-bill-1 icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-money-bill-1
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-money-bill-1))

(in-package #:cl-s3r.components.fa-money-bill-1)

(define-component fa-money-bill-1 (&key color size width height)
