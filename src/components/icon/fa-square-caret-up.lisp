;;; Font Awesome Free - square-caret-up icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-square-caret-up
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-square-caret-up))

(in-package #:cl-s3r.components.fa-square-caret-up)

(define-component fa-square-caret-up (&key color size width height)
