;;; Font Awesome Free - rectangle-times icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-rectangle-times
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-rectangle-times))

(in-package #:cl-s3r.components.fa-rectangle-times)

(define-component fa-rectangle-times (&key color size width height)
