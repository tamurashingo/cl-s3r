;;; Font Awesome Free - caret-square-down icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-caret-square-down
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-caret-square-down))

(in-package #:cl-s3r.components.fa-caret-square-down)

(define-component fa-caret-square-down (&key color size width height)
