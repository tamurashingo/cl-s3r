;;; Font Awesome Free - floppy-disk icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-floppy-disk
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-floppy-disk))

(in-package #:cl-s3r.components.fa-floppy-disk)

(define-component fa-floppy-disk (&key color size width height)
