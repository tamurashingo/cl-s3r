;;; Font Awesome Free - kiss-beam icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-kiss-beam
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-kiss-beam))

(in-package #:cl-s3r.components.fa-kiss-beam)

(define-component fa-kiss-beam (&key color size width height)
