;;; Font Awesome Free - face-tired icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-tired
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-tired))

(in-package #:cl-s3r.components.fa-face-tired)

(define-component fa-face-tired (&key color size width height)
