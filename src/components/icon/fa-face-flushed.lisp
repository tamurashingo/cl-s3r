;;; Font Awesome Free - face-flushed icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-flushed
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-flushed))

(in-package #:cl-s3r.components.fa-face-flushed)

(define-component fa-face-flushed (&key color size width height)
