;;; Font Awesome Free - drivers-license icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-drivers-license
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-drivers-license))

(in-package #:cl-s3r.components.fa-drivers-license)

(define-component fa-drivers-license (&key color size width height)
