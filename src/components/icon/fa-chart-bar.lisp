;;; Font Awesome Free - chart-bar icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-chart-bar
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-chart-bar))

(in-package #:cl-s3r.components.fa-chart-bar)

(define-component fa-chart-bar (&key color size width height)
