;;; Font Awesome Free - circle-xmark icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-circle-xmark
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-circle-xmark))

(in-package #:cl-s3r.components.fa-circle-xmark)

(define-component fa-circle-xmark (&key color size width height)
