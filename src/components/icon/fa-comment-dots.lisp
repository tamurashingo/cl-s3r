;;; Font Awesome Free - comment-dots icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-comment-dots
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-comment-dots))

(in-package #:cl-s3r.components.fa-comment-dots)

(define-component fa-comment-dots (&key color size width height)
