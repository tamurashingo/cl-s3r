;;; Font Awesome Free - face-dizzy icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-dizzy
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-dizzy))

(in-package #:cl-s3r.components.fa-face-dizzy)

(define-component fa-face-dizzy (&key color size width height)
