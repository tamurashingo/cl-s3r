;;; Font Awesome Free - kiss icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-kiss
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-kiss))

(in-package #:cl-s3r.components.fa-kiss)

(define-component fa-kiss (&key color size width height)
