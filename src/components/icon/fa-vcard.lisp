;;; Font Awesome Free - vcard icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-vcard
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-vcard))

(in-package #:cl-s3r.components.fa-vcard)

(define-component fa-vcard (&key color size width height)
