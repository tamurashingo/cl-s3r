;;; Font Awesome Free - headphones icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-headphones
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-headphones))

(in-package #:cl-s3r.components.fa-headphones)

(define-component fa-headphones (&key color size width height)
