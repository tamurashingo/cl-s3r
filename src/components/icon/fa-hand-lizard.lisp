;;; Font Awesome Free - hand-lizard icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-lizard
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-lizard))

(in-package #:cl-s3r.components.fa-hand-lizard)

(define-component fa-hand-lizard (&key color size width height)
