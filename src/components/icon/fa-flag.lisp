;;; Font Awesome Free - flag icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-flag
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-flag))

(in-package #:cl-s3r.components.fa-flag)

(define-component fa-flag (&key color size width height)
