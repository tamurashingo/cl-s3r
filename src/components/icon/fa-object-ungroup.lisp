;;; Font Awesome Free - object-ungroup icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-object-ungroup
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-object-ungroup))

(in-package #:cl-s3r.components.fa-object-ungroup)

(define-component fa-object-ungroup (&key color size width height)
