;;; Font Awesome Free - file-pdf icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-pdf
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-pdf))

(in-package #:cl-s3r.components.fa-file-pdf)

(define-component fa-file-pdf (&key color size width height)
