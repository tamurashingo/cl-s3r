;;; Font Awesome Free - circle-play icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-circle-play
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-circle-play))

(in-package #:cl-s3r.components.fa-circle-play)

(define-component fa-circle-play (&key color size width height)
