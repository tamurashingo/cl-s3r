;;; Font Awesome Free - star icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-star
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-star))

(in-package #:cl-s3r.components.fa-star)

(define-component fa-star (&key color size width height)
