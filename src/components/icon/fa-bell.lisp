;;; Font Awesome Free - bell icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-bell
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-bell))

(in-package #:cl-s3r.components.fa-bell)

(define-component fa-bell (&key color size width height)
