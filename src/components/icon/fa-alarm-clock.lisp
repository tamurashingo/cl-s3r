;;; Font Awesome Free - alarm-clock icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-alarm-clock
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-alarm-clock))

(in-package #:cl-s3r.components.fa-alarm-clock)

(define-component fa-alarm-clock (&key color size width height)
