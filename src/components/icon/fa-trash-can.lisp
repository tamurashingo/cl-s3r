;;; Font Awesome Free - trash-can icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-trash-can
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-trash-can))

(in-package #:cl-s3r.components.fa-trash-can)

(define-component fa-trash-can (&key color size width height)
