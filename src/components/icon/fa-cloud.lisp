;;; Font Awesome Free - cloud icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-cloud
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-cloud))

(in-package #:cl-s3r.components.fa-cloud)

(define-component fa-cloud (&key color size width height)
