;;; Font Awesome Free - keyboard icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-keyboard
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-keyboard))

(in-package #:cl-s3r.components.fa-keyboard)

(define-component fa-keyboard (&key color size width height)
