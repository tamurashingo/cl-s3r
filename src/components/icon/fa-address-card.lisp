;;; Font Awesome Free - address-card icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-address-card
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-address-card))

(in-package #:cl-s3r.components.fa-address-card)

(define-component fa-address-card (&key color size width height)
