;;; Font Awesome Free - rectangle-xmark icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-rectangle-xmark
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-rectangle-xmark))

(in-package #:cl-s3r.components.fa-rectangle-xmark)

(define-component fa-rectangle-xmark (&key color size width height)
