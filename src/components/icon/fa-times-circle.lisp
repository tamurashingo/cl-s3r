;;; Font Awesome Free - times-circle icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-times-circle
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-times-circle))

(in-package #:cl-s3r.components.fa-times-circle)

(define-component fa-times-circle (&key color size width height)
