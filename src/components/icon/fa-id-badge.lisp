;;; Font Awesome Free - id-badge icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-id-badge
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-id-badge))

(in-package #:cl-s3r.components.fa-id-badge)

(define-component fa-id-badge (&key color size width height)
