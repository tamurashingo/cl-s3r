;;; Font Awesome Free - xmark-circle icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-xmark-circle
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-xmark-circle))

(in-package #:cl-s3r.components.fa-xmark-circle)

(define-component fa-xmark-circle (&key color size width height)
