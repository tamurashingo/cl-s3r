;;; Font Awesome Free - comments icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-comments
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-comments))

(in-package #:cl-s3r.components.fa-comments)

(define-component fa-comments (&key color size width height)
