;;; Font Awesome Free - laugh-beam icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-laugh-beam
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-laugh-beam))

(in-package #:cl-s3r.components.fa-laugh-beam)

(define-component fa-laugh-beam (&key color size width height)
