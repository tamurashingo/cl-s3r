;;; Font Awesome Free - envelope icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-envelope
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-envelope))

(in-package #:cl-s3r.components.fa-envelope)

(define-component fa-envelope (&key color size width height)
