;;; Font Awesome Free - grin-stars icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-grin-stars
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-grin-stars))

(in-package #:cl-s3r.components.fa-grin-stars)

(define-component fa-grin-stars (&key color size width height)
