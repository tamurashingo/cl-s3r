;;; Font Awesome Free - file-word icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-word
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-word))

(in-package #:cl-s3r.components.fa-file-word)

(define-component fa-file-word (&key color size width height)
