;;; Font Awesome Free - hand-scissors icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hand-scissors
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hand-scissors))

(in-package #:cl-s3r.components.fa-hand-scissors)

(define-component fa-hand-scissors (&key color size width height)
