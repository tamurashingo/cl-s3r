;;; Font Awesome Free - heart icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-heart
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-heart))

(in-package #:cl-s3r.components.fa-heart)

(define-component fa-heart (&key color size width height)
