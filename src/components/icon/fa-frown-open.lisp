;;; Font Awesome Free - frown-open icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-frown-open
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-frown-open))

(in-package #:cl-s3r.components.fa-frown-open)

(define-component fa-frown-open (&key color size width height)
