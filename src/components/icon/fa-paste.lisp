;;; Font Awesome Free - paste icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-paste
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-paste))

(in-package #:cl-s3r.components.fa-paste)

(define-component fa-paste (&key color size width height)
