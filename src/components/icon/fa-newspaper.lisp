;;; Font Awesome Free - newspaper icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-newspaper
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-newspaper))

(in-package #:cl-s3r.components.fa-newspaper)

(define-component fa-newspaper (&key color size width height)
