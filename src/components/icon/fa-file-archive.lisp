;;; Font Awesome Free - file-archive icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-file-archive
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-file-archive))

(in-package #:cl-s3r.components.fa-file-archive)

(define-component fa-file-archive (&key color size width height)
