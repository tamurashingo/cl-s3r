;;; Font Awesome Free - paper-plane icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-paper-plane
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-paper-plane))

(in-package #:cl-s3r.components.fa-paper-plane)

(define-component fa-paper-plane (&key color size width height)
