;;; Font Awesome Free - compass icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-compass
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-compass))

(in-package #:cl-s3r.components.fa-compass)

(define-component fa-compass (&key color size width height)
