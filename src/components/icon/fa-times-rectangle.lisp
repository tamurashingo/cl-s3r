;;; Font Awesome Free - times-rectangle icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-times-rectangle
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-times-rectangle))

(in-package #:cl-s3r.components.fa-times-rectangle)

(define-component fa-times-rectangle (&key color size width height)
