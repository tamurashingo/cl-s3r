;;; Font Awesome Free - hospital icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hospital
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hospital))

(in-package #:cl-s3r.components.fa-hospital)

(define-component fa-hospital (&key color size width height)
