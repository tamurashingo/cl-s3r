;;; Font Awesome Free - face-laugh-wink icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-laugh-wink
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-laugh-wink))

(in-package #:cl-s3r.components.fa-face-laugh-wink)

(define-component fa-face-laugh-wink (&key color size width height)
