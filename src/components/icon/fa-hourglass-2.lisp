;;; Font Awesome Free - hourglass-2 icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hourglass-2
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hourglass-2))

(in-package #:cl-s3r.components.fa-hourglass-2)

(define-component fa-hourglass-2 (&key color size width height)
