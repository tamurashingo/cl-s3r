;;; Font Awesome Free - hard-drive icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-hard-drive
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-hard-drive))

(in-package #:cl-s3r.components.fa-hard-drive)

(define-component fa-hard-drive (&key color size width height)
