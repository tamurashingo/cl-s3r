;;; Font Awesome Free - square-minus icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-square-minus
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-square-minus))

(in-package #:cl-s3r.components.fa-square-minus)

(define-component fa-square-minus (&key color size width height)
