;;; Font Awesome Free - chess-knight icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-chess-knight
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-chess-knight))

(in-package #:cl-s3r.components.fa-chess-knight)

(define-component fa-chess-knight (&key color size width height)
