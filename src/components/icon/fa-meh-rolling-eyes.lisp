;;; Font Awesome Free - meh-rolling-eyes icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-meh-rolling-eyes
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-meh-rolling-eyes))

(in-package #:cl-s3r.components.fa-meh-rolling-eyes)

(define-component fa-meh-rolling-eyes (&key color size width height)
