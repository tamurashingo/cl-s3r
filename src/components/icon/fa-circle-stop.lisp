;;; Font Awesome Free - circle-stop icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-circle-stop
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-circle-stop))

(in-package #:cl-s3r.components.fa-circle-stop)

(define-component fa-circle-stop (&key color size width height)
