;;; Font Awesome Free - circle-dot icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-circle-dot
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-circle-dot))

(in-package #:cl-s3r.components.fa-circle-dot)

(define-component fa-circle-dot (&key color size width height)
