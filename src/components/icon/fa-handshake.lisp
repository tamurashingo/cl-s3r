;;; Font Awesome Free - handshake icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-handshake
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-handshake))

(in-package #:cl-s3r.components.fa-handshake)

(define-component fa-handshake (&key color size width height)
