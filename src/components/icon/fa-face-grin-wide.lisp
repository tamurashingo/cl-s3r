;;; Font Awesome Free - face-grin-wide icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-face-grin-wide
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-face-grin-wide))

(in-package #:cl-s3r.components.fa-face-grin-wide)

(define-component fa-face-grin-wide (&key color size width height)
