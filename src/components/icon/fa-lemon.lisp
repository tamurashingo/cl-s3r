;;; Font Awesome Free - lemon icon
;;; License: CC BY 4.0 License
;;; Project: https://fontawesome.com/

(defpackage #:cl-s3r.components.fa-lemon
  (:use #:cl)
  (:import-from #:cl-s3r.component #:define-component)
  (:import-from #:cl-s3r.components.icon.util #:size->css-dimension)
  (:export #:fa-lemon))

(in-package #:cl-s3r.components.fa-lemon)

(define-component fa-lemon (&key color size width height)
